...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_OCCUPATION = "B@rber";
    ...
    private static final String VALID_RISKPROFILE = BENSON.getRiskProfile().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
                VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
                VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
                 VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL, VALID_OCCUPATION,
              VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_OCCUPATION,
                 VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, null, VALID_OCCUPATION,
              VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_invalidOccupation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_OCCUPATION,
                        VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
                 INVALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
              null, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_invalidAppointmentDateFormat_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
                        VALID_ADDRESS, INVALID_APPOINTMENTDATE_FORMAT, VALID_RISKPROFILE, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_OCCUPATION,
                      VALID_ADDRESS, VALID_APPOINTMENTDATE, VALID_RISKPROFILE, invalidTags);
